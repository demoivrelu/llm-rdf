    ...
    <div class="icon-tool" >
      ...
      <div class="btn-list-group">
        ...
        <span class="btn-list-area">
          <div>
            <a class="tit" style="top: 10px">AAA</a>
            <a class="node iconfont icon-circle" draggable="true" data-label="AAA" data-shape="circle-node"></a>
          </div>
          <div>
      ...
      <div class="btn-list-group">
        ...
        <span class="btn-list-area">
          <div>
            <a class="tit" style="top: 10px">GGG</a>
            <a class="node iconfont icon-rect" draggable="true" data-label="GGG" data-shape="rect-node"></a>
          </div>
          <div>
            <a class="tit" style="top: 60px">HHH</a>
            <a class="node iconfont icon-rect" draggable="true" data-label="HHH" data-shape="rect-node"></a>
          </div>
          <div>
            <a class="tit" style="top: 110px">III</a>
            <a class="node iconfont icon-rect" draggable="true" data-label="III" data-shape="rect-node"></a>
          </div>
          <div>
      ...
      <div class="btn-list-group">
        ...
        <span class="btn-list-area">
          <div>
            <a class="tit" style="top: 10px">JJJ</a>
            <a class="node iconfont icon-diamond" draggable="true" data-label="JJJ" data-shape="diamond-node"></a>
          </div>
          <div>
